...
const recordPayment = async (req, res) => {
    try {
        const { paymentRecordId, amount, paymentMethod, referenceNumber } = req.body;
        ...
        await db.query(
            `INSERT INTO payment_transactions (
                ...
                reference_number, processed_by_cashier
            ) VALUES (?, ?, ?, ?, ?)`,
            [paymentRecordId, amount, paymentMethod, referenceNumber, req.user.userId]
        );
        ...
        // If fully paid, create student record
        if (newStatus === 'paid') {
